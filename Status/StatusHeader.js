      ...
      >
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <Status item={item} index={index} navigation={navigation} />
          )}
        />
      </View>
    </View>
...
const Status = ({ item, index, navigation }) => {
  ...
  return (
    ...
    >
      <TouchableOpacity
        onPress={() =>
          navigation.navigate("Other_UserStory", { storyData: item })
        }
        style={{
          borderWidth: 1,
          borderColor: "yellow",

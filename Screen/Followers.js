...
const Followers = ({navigation, route}) => {
        ...
        // const followers = my_profile_data.followings;
                ...
                { !following_list && !isList && <View style={{
                    ...
                    {isList && <View style={{
                        ...
                        justifyContent: 'center'
                            ...
                            <Text style={{color: 'white'}}>You doesn't have any followers</Text>
                        </View>}
...
const DisplayFollowingsList = ({item, index})=>{
    ...
    const followers = myProfileData.followings;
    const isFollowings = followers.includes(data.username);
